...
import static com.mycompany.myapp.gui.ProfileTransportForm.ch;
import static com.mycompany.myapp.gui.ProfileTransportForm.val;
 ...
 * @author Ibrahim
 */
public class ProfileFinanceForm extends SideMenuFinanceMenu {
        public String type;
    public String type1;
    ...
    public ProfileFinanceForm(Resources res) {
         super(BoxLayout.y());
...
// <editor-fold defaultstate="collapsed" desc="Generated Code">                          
    private void initGuiBuilderComponents(com.codename1.ui.util.Resources resourceObjectInstance) {
        ...
        setInlineStylesTheme(resourceObjectInstance);
                setInlineStylesTheme(resourceObjectInstance);
        setTitle("ProfileFinanceForm");
        setName("ProfileFinanceForm");
    }// </editor-fold>
...
//-- DON'T EDIT ABOVE THIS LINE!!!
    ...
    protected void showOtherForm(Resources res) {
        new ProfileFinanceForm(res).show();
    }
